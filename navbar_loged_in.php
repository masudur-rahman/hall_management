...
function myFunction() {
 ...
 <?php
 if($_SESSION['idtype']=='student') $lnk="st_profile.php";
 else $lnk="admin_profile.php";
 ?>
<div style="width:100%; margin-left: -16px;" id="myTop" class="w3-hide w3-top w3-container w3-padding-hor-10 w3-theme w3-large">
  ...
  <li  class="w3-right"><a class="w3-hover-cyan" href="logout.php"><i class="fa fa-sign-out w3-large w3-text-black"></i> Log Out</a></li>
  <li class="w3-hover-red w3-right"><a class="w3-hover-cyan" href=<?php echo $lnk?> ><i class="fa fa-user w3-large w3-text-black"></i> <?php echo $_SESSION['username'] ?></a></li>
  </div>
</ul>
  <!--</span>-->
</div>
