...
<body>
	<?php echo $info;
		...
		if (isset($_POST['add'])){
			$name=$_POST['name']; $description=$_POST['description']; $StID=$_POST['ID'];$Rname=$_POST['Rname'];

			$sql="INSERT INTO complain(Username, Name, StID, Room_No, Description) VALUES('$user', '$name', '$StID', '$Rname', '$description')";
            if(mysqli_query($conn, $sql)){
            	$last_id = mysqli_insert_id($conn);
				echo "<script type='text/javascript'>$.notify('complain submitted Successfully..','success')</script>";
		        ...
		        if (in_array($file_ext,$allowed_file_types) && ($filesize < 20000000000)){
	                ...
	                $sql="UPDATE complain SET Upload='$newfilename' WHERE ID=$last_id";
	...
	<div class="w3-row w3-khaki">
		...
		<div class="w3-col w3-container w3-teal" style="width:70%">
			...
			<form id="html5Form"  class="form-horizontal" role="form" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="POST" enctype="multipart/form-data">
				<br><br>
				<h2 style="text-align: center; font-family: Imprint MT Shadow;">Complain</h2><hr>
				<br>
		        ...
		        <div class="form-group" style="text-align: left;">
		         ...
		         <div class="form-group" style="text-align: left;">
		            <label class="control-label col-sm-3" for="Rname" style="font-size: 115%;">Room No:</label>
		            <div class="col-sm-6">
		                <input type="text" maxlength="300" class="form-control" id="Rname" pattern="[a-dA-D0-9 -]+" name="Rname" value="" placeholder="Enter Room No" required>
		            </div>
		        </div><br><br>

		        <div class="form-group" style="text-align: left;">
		            <label class="control-label col-sm-3" for="description" style="font-size: 115%;">Problem Description:</label>
		            <div class="col-sm-6">
		                <input type="text" maxlength="300" class="form-control" id="description" name="description" value="" placeholder="Enter problem Description" required>
		            </div>
		        </div><br><br>
		        ...
		        <div class="form-group" style="text-align: left;">
		            ...
		            <div>
		                <input type="file" style="margin-left: 15px;" id="event" name="event" placeholder="Upload complain">
		                  <label> (If Any) </label>
		            </div>
		        </div>

		        <div class="form-group" style="text-align: center; font-family: Times New Roman;">
		        	<button class="button" type="submit" id="add" name="add"><b><span>Complain</span></b></button><br>
		        </div><br><br>
			</form>
